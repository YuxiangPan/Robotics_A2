...
% pencilBase = transl(0,-0.25,0.06); %may want to insert into gui later

gui = GUI;

% Determines if the perspex is plotted or not. set from GUI
% disp('Select mode the press PLOT SIM to continue')
% uiwait(gui.PLOTSIMButton)
% if gui.PerspexonFrameSwitch.Value == 'Off'
%     perspexOn = false;
% else
%     perspexOn = true;
% end
